...
By now we have assumed that radiance is conserved along its ray path between surfaces. It's time to consider participating media interaction in our computation. We distinguish four different types of interaction events:
 \begin{enumerate}
